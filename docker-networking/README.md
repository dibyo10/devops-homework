...
![Frontend container running on its Docker network](../evidence/screenshots/network-frontend.png)
...
![Apache reached directly on port 80 with host networking](../evidence/screenshots/host-network-apache.png)
...
| --- | --- |
| ![Bind mount before edit](../evidence/screenshots/bind-mount-before.png) | ![Bind mount after edit](../evidence/screenshots/bind-mount-after.png) |
